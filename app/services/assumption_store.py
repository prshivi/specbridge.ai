...
class AssumptionLedgerStore:
    """SQLite persistence for fact and assumption provenance."""
    ...
    def get(
        ...
        *,
        ...
        model: str,
        prompt_version: str,
    ) -> tuple[AssumptionLedger, datetime] | None:
        ...
        if row is None:
            return None
        return (
            AssumptionLedger.model_validate_json(row["result_json"]),
